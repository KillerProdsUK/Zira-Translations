module.exports = {
  ...
  role: {
    ...
    messageOrChannelError: 'Please make sure that the message(s) and channel are setup properly and that the bot has permission to see the channel and react on the message(s) set.',
